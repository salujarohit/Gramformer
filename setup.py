...
setuptools.setup(
    ...
    install_requires=['transformers=2.11.0', 'sentencepiece==0.1.95', 'python-Levenshtein==0.12.2', 'fuzzywuzzy==0.18.0',  'tokenizers', 'fsspec==2021.5.0', 'lm-scorer==0.4.2', 'errant'],
    classifiers=[
